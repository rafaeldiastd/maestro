  ...
  >
    ...
    <div class="h-14 shrink-0 border-b border-lumina-border flex items-center justify-between px-4 bg-lumina-bg/80 backdrop-blur-md">
       <div class="flex items-center gap-2">
          ...
          <span class="text-sm font-bold text-lumina-text font-serif tracking-wide">Map Editor</span>
       </div>
       <Button 
         variant="ghost" 
         size="icon" 
          ...
          <div class="space-y-1">
             ...
             >
                <div class="flex items-center gap-2 truncate">
                   <div class="w-2 h-2 rounded-full" :class="map.is_active ? 'bg-green-500' : 'bg-transparent border border-lumina-text-muted'"></div>
       ...
       <div v-if="editingMap" class="flex-1 overflow-y-auto p-4 space-y-6 scrollbar-thin">
          ...
          <div class="space-y-1">
             ...
             <input 
                ...
                @input="updateMap('name', $event.target.value)"
          ...
          <div class="space-y-3 pt-4 border-t border-lumina-border">
             ...
             <div class="space-y-2">
                ...
                <div class="flex gap-2">
                   <input 
                      :value="editingMap.background_url"
                      @input="updateMap('background_url', $event.target.value)"
          ...
          <div class="space-y-3 pt-4 border-t border-lumina-border">
             ...
             <div class="flex items-center gap-2">
                 <div class="space-y-1 flex-1">
                    ...
                    <input 
                        type="number"
                        :value="editingMap.grid_cell_width"
                 ...
                 <div class="space-y-1 flex-1">
                    ...
                    <input 
                        type="number"
                        :value="editingMap.grid_cell_height"
                 ...
                 <div class="space-y-1 w-20">
                    ...
                    <input 
                        type="number"
                        min="1"
                        :value="editingMap.grid_line_width"
             ...
             <div class="space-y-2">
                 ...
                 <div class="grid grid-cols-2 gap-2">
                    <div class="space-y-1">
                       ...
                       <input 
                          type="number"
                          :value="editingMap.grid_offset_top"
                    ...
                    <div class="space-y-1">
                       ...
                       <input 
                          type="number"
                          :value="editingMap.grid_offset_bottom"
                    ...
                    <div class="space-y-1">
                       ...
                       <input 
                          type="number"
                          :value="editingMap.grid_offset_left"
                    ...
                    <div class="space-y-1">
                       ...
                       <input 
                          type="number"
                          :value="editingMap.grid_offset_right"
          ...
          <div class="pt-4 mt-4 border-t border-lumina-border">
             <Button 
               size="default" 
               :variant="editingMap.is_active ? 'default' : 'outline'"
